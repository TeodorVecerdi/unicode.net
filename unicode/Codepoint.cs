...
public readonly struct Codepoint : IComparable<Codepoint>, IComparable<uint>, IEquatable<Codepoint>,
    ...
    public Codepoint FromUtf16(ushort word1, ushort word2 = 0) {
        ...
        const int leadOffset = 0xD800 - (0x10000 >> 10);
        const int surrogateOffset = 0x10000 - (0xD800 << 10) - 0xDC00;

        var lead = (short)(leadOffset + (word1 >> 10));
        var trail = (short)(0xDC00 + (word1 & 0x3FF));

        var codepoint = (uint)((lead << 10) + trail + surrogateOffset);
